    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-gray-900 p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="artistId" className="block text-sm font-medium text-white">Artist ID</label>
            <input
              type="number"
              id="artistId"
              value={artistId}
          ...
          <div className="mb-4">
            <label htmlFor="albumName" className="block text-sm font-medium text-white">Album Name</label>
            <input
              type="text"
              id="albumName"
              value={albumName}
