          ...
          <form onSubmit={handleSubmit(onSubmitHandler)} className="space-y-4">
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="Name"
                {...register('name')}
                className={`border ${errors.name ? 'border-red-600' : 'border-gray-600'} bg-gray-700 text-white p-2 rounded w-full`}
              />
            ...
            <div className="mb-4">
              <label className="block text-gray-300 text-sm font-medium mb-2" htmlFor="firstReleaseYear">
                First Release Year
              </label>
              <input
                type="number"
                ...
                className={`border ${errors.firstReleaseYear ? 'border-red-600' : 'border-gray-600'} bg-gray-700 text-white p-2 rounded w-full`}
              />
              {errors.firstReleaseYear && <p className="text-red-600 text-sm">{errors.firstReleaseYear.message}</p>}
            </div>
            <div className="mb-4">
              <label className="block text-gray-300 text-sm font-medium mb-2" htmlFor="noOfAlbumsReleased">
              ...
              <input
                ...
                className={`border ${errors.noOfAlbumsReleased ? 'border-red-600' : 'border-gray-600'} bg-gray-700 text-white p-2 rounded w-full`}
              />
              {errors.noOfAlbumsReleased && <p className="text-red-600 text-sm">{errors.noOfAlbumsReleased.message}</p>}
            </div>
